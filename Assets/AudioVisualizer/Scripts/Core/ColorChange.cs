...
namespace AudioVisualizer
{
    ...
    public class ColorChange : MonoBehaviour
    {
        ...
        void LerpColors()
		{
            ...
            audioColor = gradient.Evaluate(value);
            /*
            ...
            */
            ...
            foreach (Material mat in materials)
            {
                ...
                {
                    mat.SetColor(colorProperty, audioColor);
                }
            }

            if(trail != null)
            {
                trail.startColor = audioColor;
                trail.endColor = audioColor;
            }

            if(particles != null)
            {
                particles.startColor = audioColor;
            }
